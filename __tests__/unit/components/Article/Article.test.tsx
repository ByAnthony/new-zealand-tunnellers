...
describe("Article", () => {
  ...
  test("renders multiple map links for Always Digging", () => {
    ...
    expect(
      ...
      "href",
      "/history/tunnellers-works/?period=true&frontlines=true&from=1917-04-10&to=1918-03-20",
    );
    expect(
      screen.getByRole("link", { name: /1918 German Spring Offensive/i }),
    ).toHaveAttribute(
      "href",
      "/history/tunnellers-works/?period=true&frontlines=true&from=1918-03-21&to=1918-07-14",
    );
    expect(
      ...
      "href",
      "/history/tunnellers-works/?period=true&frontlines=true&from=1918-07-15&to=1918-08-21",
    );
  });
});
